...
public class ParaguayCiValidator extends Mod11Validator {

    public ParaguayCiValidator() {
        // Pesos específicos para la CI paraguaya
        super(new int[]{2, 3, 4, 5, 6, 7, 8, 9}, true, 9, false);
    }

    @Override
    public String getDocumentType() {
        return "Cédula de Identidad Paraguaya";
    }
}